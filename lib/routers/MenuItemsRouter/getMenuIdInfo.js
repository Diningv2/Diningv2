...
exports.default = getMenuIdInfo;

var _axios = _interopRequireDefault(require("axios"));

var _parseMenuItemData = _interopRequireDefault(require("./parseMenuItemData"));
...
async function getMenuIdInfo(menuitemid) {
  ...
  try {
    const nutritionResponse = await _axios.default.get(nutritionEndpoint);
    const filterResponse = await _axios.default.get(filterEndpoint);
    const ingredientsResponse = await _axios.default.get(ingredientsEndpoint);
    const menu = (0, _parseMenuItemData.default)(nutritionResponse.data, filterResponse.data, ingredientsResponse.data);
    return menu;
  } catch (e) {
